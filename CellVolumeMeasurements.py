...
class CellVolumeMeasurement(SteppableBasePy):
    ...
    def __init__(self, frequency=1, run_id=0):
        ...
        # Wound center
        self.wound_center = np.array([grid_x/2, grid_y/2])
    ...
    def start(self, run_id=0):
        ...
        with open(self.output_file, "w") as f:
            ...
            f.write(f"# Wound Radius: R={wR}\n")
            f.write(f"# Fixed Target Volume: {target_volume}\n")
            f.write(f"# Fixed Lambda Volume: {lambda_volume}\n")
